  ...
  return (
    ...
    >
      ...
      <div className="relative w-[72px] h-[72px] mx-auto">
        ...
        <span className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 text-xs font-medium text-muted-foreground">
          S
        </span>
        <span className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-0.5 text-xs font-medium text-muted-foreground">
          W
        </span>
        <span className="absolute right-0 top-1/2 translate-x-0.5 -translate-y-1/2 text-xs font-medium text-muted-foreground">
          E
        </span>
        <svg
          viewBox="0 0 64 64"
        ...
        >
          ...
          <path
            d="M32 20 L35 32 L32 38 L29 32 Z"
            fill="currentColor"
            fillOpacity="0.35"
            stroke="currentColor"
            strokeWidth="1"
